const embed = new EmbedBuilder()
  ...
  .setDescription('Please go through our verification portal at https://imsimulatorgaming.github.io/accesspointverifportal/')
  .setColor(0x6366F1);

try {
  await interaction.user.send({ embeds: [embed] });<?php
/* Discord Oauth v.4.1
